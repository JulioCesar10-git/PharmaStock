...
def main(page: ft.Page):
    ...
    # --- HELPER FUNCTIONS FOR REUSABLE STYLES ---
    ...
    # 1. Cabecera (Botón atrás + Título + Subtítulo)
    header = ft.Column(
        controls=[
            ft.Row(
                controls=[
            ...
            # Usamos alignment=ft.Alignment(0, 0) o simplemente el text_align del Text para centrar
            ft.Row(
                controls=[
                    ft.Text(
                        "Ingresa los datos:",
    ...
    # 2. Caja de imagen con trazado en X (Canvas) + Botón flotante
    image_box = ft.Stack(
        controls=[
            ft.Container(
                width=135,
    ...
    # 3. Campos superiores a la derecha de la imagen
    ...
    )  # <-- Agregado paréntesis de cierre para ft.Container
